...
public:
	...
	XMMATRIX GetNodeWorldTM(const std::wstring& nodeName) const;
	XMMATRIX GetNodeWorldTM(const wchar_t* nodeName) const {
		return GetNodeWorldTM(std::wstring(nodeName));
	}
