...
public:
	...
	bool SetScreenResolution(ID3D11DeviceContext*);
	bool SetCollisionCount(int, ID3D11DeviceContext*);

	bool SetTitleGoal(ID3D11DeviceContext*);
	bool SetTitleControl(ID3D11DeviceContext*);
	bool SetTitleDeveloper(ID3D11DeviceContext*);
	bool SetTitleInfo(ID3D11DeviceContext*);
